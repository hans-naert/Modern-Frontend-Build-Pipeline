(() => {
  ...
  var REVISION_SEARCH_PARAM;
  var init_createCacheKey = __esm({
    "node_modules/workbox-precaching/utils/createCacheKey.js"() {
      init_WorkboxError();
      init_version2();
      REVISION_SEARCH_PARAM = "__WB_REVISION__";
    }
  });

  // node_modules/workbox-precaching/utils/PrecacheInstallReportPlugin.js
  var PrecacheInstallReportPlugin;
  var init_PrecacheInstallReportPlugin = __esm({
    "node_modules/workbox-precaching/utils/PrecacheInstallReportPlugin.js"() {
      init_version2();
  ...
  var PrecacheCacheKeyPlugin;
  var init_PrecacheCacheKeyPlugin = __esm({
    "node_modules/workbox-precaching/utils/PrecacheCacheKeyPlugin.js"() {
      init_version2();
  ...
  var logGroup;
  var init_printCleanupDetails = __esm({
    "node_modules/workbox-precaching/utils/printCleanupDetails.js"() {
      init_logger();
      init_version2();
  ...
  var init_printInstallDetails = __esm({
    "node_modules/workbox-precaching/utils/printInstallDetails.js"() {
      init_logger();
      init_version2();
    }
  ...
  var PrecacheStrategy;
  var init_PrecacheStrategy = __esm({
    "node_modules/workbox-precaching/PrecacheStrategy.js"() {
      init_copyResponse();
      init_cacheNames();
      init_getFriendlyURL();
      ...
      init_Strategy();
      init_version2();
      PrecacheStrategy = class _PrecacheStrategy extends Strategy {
        /**
         *
         * @param {Object} [options]
         * @param {string} [options.cacheName] Cache name to store and retrieve
  ...
  var init_PrecacheController = __esm({
    "node_modules/workbox-precaching/PrecacheController.js"() {
      init_assert();
      init_cacheNames();
      init_logger();
      ...
      init_waitUntil();
      init_createCacheKey();
      init_PrecacheInstallReportPlugin();
      init_PrecacheCacheKeyPlugin();
      init_printCleanupDetails();
      init_printInstallDetails();
      init_PrecacheStrategy();
      init_version2();
...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`;
  ...
  var init_getOrCreatePrecacheController = __esm({
    "node_modules/workbox-precaching/utils/getOrCreatePrecacheController.js"() {
      init_PrecacheController();
      init_version2();
  ...
  var init_addPlugins = __esm({
    "node_modules/workbox-precaching/addPlugins.js"() {
      init_getOrCreatePrecacheController();
      init_version2();
    }
  });
  ...
  var init_removeIgnoredSearchParams = __esm({
    "node_modules/workbox-precaching/utils/removeIgnoredSearchParams.js"() {
      init_version2();
    }
  });
  ...
  var init_generateURLVariations = __esm({
    "node_modules/workbox-precaching/utils/generateURLVariations.js"() {
      init_removeIgnoredSearchParams();
      init_version2();
    }
  });
  ...
  var PrecacheRoute;
  var init_PrecacheRoute = __esm({
    "node_modules/workbox-precaching/PrecacheRoute.js"() {
      init_logger();
      init_getFriendlyURL();
      init_Route();
      init_generateURLVariations();
      init_version2();
      PrecacheRoute = class extends Route {
        /**
  ...
  var init_deleteOutdatedCaches = __esm({
    "node_modules/workbox-precaching/utils/deleteOutdatedCaches.js"() {
      init_version2();
    }
  });
  ...
  var init_cleanupOutdatedCaches = __esm({
    "node_modules/workbox-precaching/cleanupOutdatedCaches.js"() {
      init_cacheNames();
      init_logger();
      init_deleteOutdatedCaches();
      init_version2();
    }
  });

  // node_modules/workbox-precaching/createHandlerBoundToURL.js
  var init_createHandlerBoundToURL = __esm({
    "node_modules/workbox-precaching/createHandlerBoundToURL.js"() {
      init_getOrCreatePrecacheController();
      init_version2();
    }
  ...
  var init_getCacheKeyForURL = __esm({
    "node_modules/workbox-precaching/getCacheKeyForURL.js"() {
      init_getOrCreatePrecacheController();
      init_version2();
    }
  ...
  var init_precacheAndRoute = __esm({
    "node_modules/workbox-precaching/precacheAndRoute.js"() {
      init_addRoute();
      init_precache();
      init_version2();
  ...
  var init_PrecacheFallbackPlugin = __esm({
    "node_modules/workbox-precaching/PrecacheFallbackPlugin.js"() {
      init_getOrCreatePrecacheController();
      init_version2();
    }
  ...
  var init_workbox_precaching = __esm({
    "node_modules/workbox-precaching/index.js"() {
      init_addPlugins();
      init_addRoute();
      init_cleanupOutdatedCaches();
      init_createHandlerBoundToURL();
      init_getCacheKeyForURL();
      init_matchPrecache();
      init_precache();
      init_precacheAndRoute();
      init_PrecacheController();
      init_PrecacheRoute();
      init_PrecacheStrategy();
      init_PrecacheFallbackPlugin();
      init_version2();
      init_types();
    }
  });
